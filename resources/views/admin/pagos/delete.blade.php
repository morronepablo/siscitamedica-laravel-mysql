...
@section('content')
    <div class="content-header">
        <h1>Pago del paciente: <span class="text-danger">{{ $pago->paciente->apellidos }},
                    ...
                    <div class="card card-danger">
                        <div class="card-header">
                            <div class="btn bg-transparent btn-sm">
                                <h3 class="card-title text-white">¿Está seguro de querer eliminar este pago?</h3>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-danger float-right"><i
                                                    class="bi bi-floppy"></i> Eliminar pago</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
