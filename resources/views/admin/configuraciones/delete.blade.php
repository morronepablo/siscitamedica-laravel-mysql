...
@section('content')
    <div class="content-header">
        <h1>Configuracion: <span class="text-danger">{{ $configuracion->nombre }}</span></h1>
        </h1>
        <hr>
    </div>
    <div class="content">
                    ...
                    <div class="card card-danger">
                        <div class="card-header">
                            <div class="btn bg-transparent btn-sm">
                                <h3 class="card-title text-white">¿Está seguro de querer eliminar ésta configuración?</h3>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.configuraciones.destroy', $configuracion->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-danger float-right"><i
                                                    class="bi bi-floppy"></i> Eliminar configuración</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
