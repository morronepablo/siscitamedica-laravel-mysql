                ...
                <div class="col-md-12">
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            ...
                            <a href="{{ route('admin.doctores.create') }}" class="btn btn-primary btn-sm float-right">
                                <i class="bi bi-person-add"></i> Nuevo Doctor
                            </a>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <a href="{{ route('admin.doctores.confirmDelete', $doctor->id) }}"
