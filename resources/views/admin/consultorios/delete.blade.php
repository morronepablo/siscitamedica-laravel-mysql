...
@section('content')
    <div class="content-header">
        <h1>Consultorio: <span class="text-danger">{{ $consultorio->nombre }}</span>
        </h1>
        <hr>
    </div>
    <div class="content">
                    ...
                    <div class="card card-danger">
                        <div class="card-header">
                            <div class="btn bg-transparent btn-sm">
                                <h3 class="card-title text-white">¿Está seguro de querer eliminar este consultorio?</h3>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-danger float-right"><i
                                                    class="bi bi-floppy"></i> Eliminar consultorio</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
