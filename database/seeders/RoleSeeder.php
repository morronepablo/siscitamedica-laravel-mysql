...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Ruta ajax
        Permission::create(['name' => 'admin.horarios.cargaConsultorios'])->syncRoles([$admin, $secretaria]);

        // Rutas para el usuario
        // Ajax
        Permission::create(['name' => 'cargaConsultorios'])->syncRoles([$admin, $usuario]);
        ...
        Permission::create(['name' => 'admin.events.create'])->syncRoles([$admin, $usuario]);
        Permission::create(['name' => 'admin.events.destroy'])->syncRoles([$admin, $usuario]);
        ...
        Permission::create(['name' => 'admin.historial.paciente'])->syncRoles([$admin, $doctor]);
        Permission::create(['name' => 'admin.historial.historial'])->syncRoles([$admin, $doctor]);
